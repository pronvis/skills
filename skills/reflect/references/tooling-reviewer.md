...
- `read` tool calls against any `SKILL.md` file (this vendored repo `~/it/skills/skills/`, project `.agents/skills/` or `.omp/skills/`, user-level `~/.agents/skills/`, or plugin-installed paths under `~/.omp/plugins/`)
